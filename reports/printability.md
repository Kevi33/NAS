...
| `base_rear` | 146.00 × 145.55 × 60.00 mm | PASS | PASS | PASS | 1/1 | 4984 | 0.077275 mm² | largest flat face on bed; detail side up | none |
...
| `mid_frame` | 146.00 × 174.00 × 8.00 mm | PASS | PASS | PASS | 1/1 | 548 | 0.071109 mm² | broad face on bed | none |
| `mid_frame_right_spine` | 8.00 × 164.00 × 8.00 mm | PASS | PASS | PASS | 1/1 | 92 | 1.110000 mm² | largest flat face on bed; detail side up | none |
| `hdd_tray_front` | 124.30 × 107.25 × 9.00 mm | PASS | PASS | PASS | 1/1 | 148 | 1.200000 mm² | largest flat face on bed; detail side up | none |
| `hdd_tray_rear` | 124.30 × 101.25 × 9.00 mm | PASS | PASS | PASS | 1/1 | 110 | 0.085000 mm² | largest flat face on bed; detail side up | none |
| `hdd_keeper` | 7.70 × 15.40 × 9.00 mm | PASS | PASS | PASS | 1/1 | 56 | 0.045000 mm² | largest flat face on bed; detail side up | none |
| `pi_tray` | 128.00 × 95.00 × 8.00 mm | PASS | PASS | PASS | 1/1 | 184 | 1.400000 mm² | largest flat face on bed; detail side up | none |
...
| `hdd_keeper_fit_test` | 26.10 × 32.00 × 9.00 mm | PASS | PASS | PASS | 2/2 | 100 | 0.045000 mm² | flat coupon base on bed; labels and joint openings upward | none |
...
- **PASS** — NON-ZERO VOLUME: base_front: Source 59998.868 mm³; signed STL 59999.354 mm³; VTK 59999.354 mm³; all 1 component volume(s) positive.
- **PASS** — SOURCE/EXPORT IDENTITY: base_front: Source 1 solid(s), STEP 1; source/STL volume matches, source/STEP volume matches.
- **PASS** — MANIFOLD: base_rear: 4984 triangles, 1 raw/1 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 0.077275 mm²; source BRep valid (0 degenerate edges).
...
- **PASS** — NON-ZERO VOLUME: base_rear: Source 59359.281 mm³; signed STL 59359.946 mm³; VTK 59359.946 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: rear_panel: Source 44720.201 mm³; signed STL 44733.659 mm³; VTK 44733.659 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: left_side_front: Source 64889.980 mm³; signed STL 64890.421 mm³; VTK 64890.421 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: left_side_rear: Source 64040.737 mm³; signed STL 64041.224 mm³; VTK 64041.224 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: right_side_front: Source 64889.980 mm³; signed STL 64890.421 mm³; VTK 64890.421 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: right_side_rear: Source 64040.737 mm³; signed STL 64041.224 mm³; VTK 64041.224 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: top_service_lid: Source 55594.095 mm³; signed STL 55594.792 mm³; VTK 55594.792 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: top_rear: Source 55854.247 mm³; signed STL 55854.908 mm³; VTK 55854.908 mm³; all 1 component volume(s) positive.
- **PASS** — SOURCE/EXPORT IDENTITY: top_rear: Source 1 solid(s), STEP 1; source/STL volume matches, source/STEP volume matches.
- **PASS** — MANIFOLD: mid_frame: 548 triangles, 1 raw/1 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 0.071109 mm²; source BRep valid (0 degenerate edges).
...
- **PASS** — NON-ZERO VOLUME: mid_frame: Source 26033.504 mm³; signed STL 26033.502 mm³; VTK 26033.502 mm³; all 1 component volume(s) positive.
- **PASS** — SOURCE/EXPORT IDENTITY: mid_frame: Source 1 solid(s), STEP 1; source/STL volume matches, source/STEP volume matches.
- **PASS** — MANIFOLD: mid_frame_right_spine: 92 triangles, 1 raw/1 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 1.110000 mm²; source BRep valid (0 degenerate edges).
...
- **PASS** — NON-ZERO VOLUME: mid_frame_right_spine: Source 9503.120 mm³; signed STL 9503.120 mm³; VTK 9503.120 mm³; all 1 component volume(s) positive.
...
- **PASS** — NON-ZERO VOLUME: hdd_tray_front: Source 7484.370 mm³; signed STL 7484.370 mm³; VTK 7484.370 mm³; all 1 component volume(s) positive.
- **PASS** — SOURCE/EXPORT IDENTITY: hdd_tray_front: Source 1 solid(s), STEP 1; source/STL volume matches, source/STEP volume matches.
- **PASS** — MANIFOLD: hdd_tray_rear: 110 triangles, 1 raw/1 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 0.085000 mm²; source BRep valid (0 degenerate edges).
...
- **PASS** — NON-ZERO VOLUME: hdd_tray_rear: Source 7111.278 mm³; signed STL 7111.278 mm³; VTK 7111.278 mm³; all 1 component volume(s) positive.
- **PASS** — SOURCE/EXPORT IDENTITY: hdd_tray_rear: Source 1 solid(s), STEP 1; source/STL volume matches, source/STEP volume matches.
- **PASS** — MANIFOLD: hdd_keeper: 56 triangles, 1 raw/1 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 0.045000 mm²; source BRep valid (0 degenerate edges).
- **PASS** — PRINT BED: hdd_keeper: STL 7.70 × 15.40 × 9.00 mm; validated usable envelope 250.00 × 250.00 × 250.00 mm; source/STL bounds match; orthogonal alternative YES.
- **PASS** — NON-ZERO VOLUME: hdd_keeper: Source 425.946 mm³; signed STL 425.946 mm³; VTK 425.946 mm³; all 1 component volume(s) positive.
- **PASS** — SOURCE/EXPORT IDENTITY: hdd_keeper: Source 1 solid(s), STEP 1; source/STL volume matches, source/STEP volume matches.
- **PASS** — MANIFOLD: pi_tray: 184 triangles, 1 raw/1 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 1.400000 mm²; source BRep valid (0 degenerate edges).
...
- **PASS** — NON-ZERO VOLUME: pi_tray: Source 11825.440 mm³; signed STL 11825.440 mm³; VTK 11825.440 mm³; all 1 component volume(s) positive.
...
- **PASS** — MANIFOLD: hdd_keeper_fit_test: 100 triangles, 2 raw/2 VTK region(s); boundary 0, non-manifold 0, winding 0, vertex-link 0, sliver/degenerate 0, duplicate 0, normal 0, self-intersection 0; minimum triangle area 0.045000 mm²; source BRep valid (0 degenerate edges).
- **PASS** — PRINT BED: hdd_keeper_fit_test: STL 26.10 × 32.00 × 9.00 mm; validated usable envelope 250.00 × 250.00 × 250.00 mm; source/STL bounds match; orthogonal alternative YES.
- **PASS** — NON-ZERO VOLUME: hdd_keeper_fit_test: Source 1012.686 mm³; signed STL 1012.686 mm³; VTK 1012.686 mm³; all 2 component volume(s) positive.
...
- **PASS** — STEP artifact: NAS_Assembly: Reopened with 42 valid solid(s), volume 2996502.14 mm³; expected 42 solid(s) and 2996502.14 mm³.
- **PASS** — STEP artifact: NAS_Exploded: Reopened with 42 valid solid(s), volume 2996502.14 mm³; expected 42 solid(s) and 2996502.14 mm³.
- **PASS** — STEP artifact: NAS_Internal_Inspection: Reopened with 37 valid solid(s), volume 2709914.34 mm³; expected 37 solid(s) and 2709914.34 mm³.
- **PASS** — STEP artifact: NAS_Clearance_Check: Reopened with 81 valid solid(s), volume 7724014.30 mm³; expected 81 solid(s) and 7724014.30 mm³.
